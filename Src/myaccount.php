...
$res=mysqli_query($conn,"SELECT * FROM customer JOIN vehicle ON customer.v_id=vehicle.v_id WHERE customer.c_id=$id;");
...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<img src="<?php echo $Row['image']?>" width="600" height="370">
			</div>
