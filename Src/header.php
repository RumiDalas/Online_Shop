...
$ut=mysqli_query($conn,"SELECT COUNT(*) FROM users;");
$ucount=mysqli_free_result($ut);

$vt=mysqli_query($conn,"SELECT COUNT(*) FROM customer;");
$vcount=mysqli_free_result($vt);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  ?>
			...
			<li><a href="view_booking.php"><svg class="glyph stroked table"><use xlink:href="#stroked-calendar"></use></svg> View Booking</a></li>
