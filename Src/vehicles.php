...
$query_parent = mysqli_query($conn,"SELECT * FROM manufacturer") or die("Query failed: ".mysqli_error());
?>
<?php
if(isset($_POST['submit']))
{
	$manufacturer_name =  mysqli_real_escape_string($con,$_POST['manufacturer_name']);
	...
	$status =  "Available";
	$registration_year =  mysqli_real_escape_string($con,$_POST['registration_year']);
	$insurance_id =  mysqli_real_escape_string($con,$_POST['insurance_id']);
	$gear =  mysqli_real_escape_string($con,$_POST['gear']);
